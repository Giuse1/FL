...
train_loss0, train_acc0, val_loss0, val_acc0 = read_file("results_final/standard_first150_1le_.txt")
train_loss1, train_acc1, val_loss1, val_acc1 = read_file("results_final/standard_nonIID_first150u_1le")
train_loss2, train_acc2, val_loss2, val_acc2 = read_file("results_final/hybrid_nonIID_first150u_1le")
train_loss3, train_acc3, val_loss3, val_acc3 = read_file("results_final/standard_random_1000u_1le")

plt.figure()
plt.plot(val_loss0, label='standard_first150_1le')
plt.plot(val_loss1, label='standard_nonIID_first150u_1le')
plt.plot(val_loss2, label='hybrid_nonIID_first150u_1le')
...
plt.figure()
plt.plot(val_acc0, label='standard_first150_1le')
plt.plot(val_acc1, label='standard_nonIID_first150u_1le')
plt.plot(val_acc2, label='hybrid_nonIID_first150u_1le')
